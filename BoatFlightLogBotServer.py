...
async def post_flight_log(data):
    ...
    embed.add_field(name="Passengers", value=str(data.get("passengers", "N/A")), inline=True)
    embed.add_field(name="Cargo", value=str(data.get("cargo", "N/A")), inline=True)
    ...
    embed.add_field(name="Cruise Altitude", value=data.get("cruise_altitude", "???"), inline=True)
    embed.add_field(name="Airspeed", value=data.get("airspeed", "???"), inline=True)
